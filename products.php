...
<div id="wrapper" class="clearfix">
    ...
    <div class="col-md-12 hed">
        <center>
            ...
            <a href="comenzi.php" type="button" class="btn btn-success btn-sm">Vizualizare comenzi</a>
        </center>
    </div>
    <section id="content">
            ...
            <div class="container clearfix">
                <div class="row">
                    <div class="col-md-12" id="hide">
                        <form  class="row form" action="./CRUD/insert.php" method="post">
                            <?php include './CRUD/form.php'; ?>
                        ...
                        <table class="table table-dark">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['produs_pret']; ?> lei</td>
                                    ...
                                    <td>
                                        <a href="view.php?id=<?php echo $row['produs_id']; ?>" type="button" class="btn btn-success btn-sm">View</a>
                                    </td>
                                    <td>
                                        <a href="./CRUD/edit.php?id=<?php echo $row['produs_id']; ?>" type="button" class="btn btn-primary btn-sm">Edit</a>
                                    </td>
                                    <td>
                                        <a href="./CRUD/delete_data.php?id=<?php echo $row['produs_id']; ?>" type="button" class="btn btn-primary btn-danger">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
